...
Статус: выполнено в переходной модели. `Customer.car` сохранен для
совместимости, `Car.customer` стал основной связью владения, список машин
возвращает несколько активных автомобилей, добавлены create/update/soft-delete
endpoints и проверки booking на чужие или неактивные машины.
