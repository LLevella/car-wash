...
class AdminLanguageSwitcherTests(TestCase):
    ...
    def test_admin_language_switch_updates_rendered_admin_chrome(self):
        ...
        self.assertContains(response, "Resource blocks")
        self.assertContains(response, "Wash bays")
        self.assertContains(response, "Car brands")
        ...
        self.assertNotContains(response, "Блокировки ресурсов")
        self.assertNotContains(response, "Марки авто")
        self.assertNotContains(response, "Автомобили")
