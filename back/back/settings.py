...
if not SECRET_KEY:
    if DEBUG or RUNNING_TESTS:
        SECRET_KEY = "local-dev-secret-key-for-car-wash-tests-only-change-me"
    else:
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'auth_login': os.environ.get("DRF_AUTH_LOGIN_THROTTLE_RATE", "20/min"),
        'auth_register': os.environ.get("DRF_AUTH_REGISTER_THROTTLE_RATE", "5/hour"),
    },
}
